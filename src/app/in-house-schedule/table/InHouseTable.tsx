...
//   // Distribute statuses evenly for testing
//   return {
//     id: i + 1,
...
//     status: statuses[i % 3], // 0=New, 1=Approved, 2=Ongoing
//   };
// });
...
//   // Navigation (Default to "New" as it's usually the priority action item)
...
//   return (
//     <div className="w-full rounded-3xl bg-white p-6 shadow-sm border border-slate-100 font-sans min-h-[600px] flex flex-col relative">
      
//       {/* --- Bulk Action Floating Bar (Only if "New" items selected) --- */}
...
//             </button>
//           ))}
//           {/* Optional 'All' tab if you still want an overview, otherwise remove */}
//           <button
...
//         {/* Right: Search & Filter (Status Filter Removed) */}
...
//                           {/* Only show Approve & Edit if status is "New" */}
//                           {row.status === "New" && (
//                             <>
