...
const RegisteredModel = () => {
  return (
    <div className="relative bg-gradient-to-r from-green-400 to-teal-500 text-white rounded-lg p-5 shadow-md overflow-hidden w-full">
      <div className="absolute top-3 right-3 text-white text-2xl opacity-90">
        <FaSeedling />
      </div>

      <p className="text-sm font-medium">Registered Hydroponic Model</p>
