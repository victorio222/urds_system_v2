...
const RegisteredSensor = () => {
  return (
    <div className="relative bg-gradient-to-r from-red-300 to-rose-400 text-white rounded-lg p-5 shadow-md overflow-hidden w-full">
      <div className="absolute top-3 right-3 text-white text-2xl opacity-90">
        <BiChip />
      </div>

      <p className="text-sm font-medium">Registered Sensors</p>
...
export default RegisteredSensor;
