...
export default function MonthlyResearchAnalytics() {
  ...
  return (
    <div className="bg-white p-3 rounded-lg shadow-lg w-full sm:flex-row items-center sm:items-start gap-4">
      {/* Title */}
      <div className="w-full sm:w-auto text-center sm:text-left">
        <p className="text-xs lg:text-sm font-medium text-slate-500 mb-1">
