...
//                 <p className="text-sm text-left flex items-center">
//                   <span className="pr-2"><ErrorOutline className="h-5 w-5" /></span>
//                   {error}
//                 </p>
//               </div>
//             )}
...
//             <div className="text-right -mt-2">
//               <Link href="/auth/forgot-password" className="text-blue-400 text-xs hover:text-blue-500 transition">
//                 Forgot Password?
//               </Link>
//             </div>
...
//             <p className="text-center mt-3 text-xs text-gray-400 mb-[-12px]">
//               Don't have an account?{" "}
//               <Link href="/auth/signup" className="text-blue-400 hover:text-blue-500 transition">
//                 Sign up
//               </Link>
//             </p>
//           </form>
