    ...
    >
      ...
      <div className="overflow-x-auto mb-10">
        <table className="border-collapse border border-black w-full">
          <tbody>
            <tr>
              <td className="border border-black px-2 py-1">Program/Project/Study Title:</td>
              <td className="border border-black px-2 py-1" colSpan={4}></td>
            </tr>
            <tr>
              <td className="border border-black px-2 py-1">Program/Project Study Leader:</td>
              <td className="border border-black px-2 py-1" colSpan={4}></td>
            </tr>
            <tr>
              <td className="border border-black px-2 py-1">College/Unit/Campus:</td>
              <td className="border border-black px-2 py-1" colSpan={4}></td>
            </tr>
            <tr>
              <td className="border border-black px-2 py-1 font-bold">Item</td>
              <td className="border border-black px-2 py-1 text-center font-bold">Year 1</td>
              <td className="border border-black px-2 py-1 text-center font-bold">Year 2</td>
              <td className="border border-black px-2 py-1 text-center font-bold">Total</td>
            </tr>
