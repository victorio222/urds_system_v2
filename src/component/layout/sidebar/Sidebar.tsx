...
const sidebar: SidebarItem[] = [
  ...
  },
  {
    ...
    allowedRoles: ["Research Evaluator"],
  },
  {
...
const SidebarLayout: React.FC<SidebarLayoutProps> = ({
  ...
  return (
    <>
      ...
      <aside
        className={`fixed top-0 left-0 bg-white p-4 h-screen w-64 text-slate-800 z-40 transform transition-transform duration-300 overflow-y-auto
