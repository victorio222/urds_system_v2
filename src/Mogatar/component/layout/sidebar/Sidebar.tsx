...
const sidebar: SidebarItem[] = [
    { title: 'Dashboard', link: '/dashboard', icon: <AiOutlineDashboard size={20} /> },
    {
        ...
        subItems: [
            { title: 'All Research Projects', link: '/research-projects/AllCollegeProject' },
            { title: 'My Research Projects', link: '/research-projects/new' },
            { title: 'Submit Research', link: '/research-projects/new' },
            { title: 'Pending', link: '/research-projects/pending' },
                        ...
                        {item.subItems ? (
                            <>
                                ...
                                <button
                                    ...
                                    className={`flex items-center gap-5 w-full cursor-pointer text-[13px] font-medium py-2 px-3 rounded-md transition-colors ${
